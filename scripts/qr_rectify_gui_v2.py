...
python3 scripts/qr_rectify_gui_v2.py --input data/raw --roi-config configs/roi_tuner_params.json

# Anderes Runs-Verzeichnis + bestimmter Run (0=newest)
python3 scripts/qr_rectify_gui_v2.py --input data/raw --roi-config configs/roi_tuner_params.json --runs-dir runs/cnn_scratch --run-index 1

# Device erzwingen
python3 scripts/qr_rectify_gui_v2.py --input data/raw --roi-config configs/roi_tuner_params.json --device mps
python3 scripts/qr_rectify_gui_v2.py --input data/raw --roi-config configs/roi_tuner_params.json --device cuda
python3 scripts/qr_rectify_gui_v2.py --input data/raw --roi-config configs/roi_tuner_params.json --device cpu
"""
