...
\begin{listArab}
    \item Entwicklung eines \ac{CNN} zur Erkennung von \ac{QR}-Codes in Bildern, die unter den genannten Bedingungen aufgenommen wurden.
    \item Weiterverarbeitung der erkannten \ac{QR}-Codes, um deren Lesbarkeit zu überprüfen und Empfehlungen für die Ausrichtung einer darüber montierten Kamera zu geben.
\end{listArab}

Der vollständige Quellcode (inkl. Trainings- und GUI-Skripte) sowie die verwendeten Konfigurationen
sind in einem öffentlichen GitHub-Repository verfügbar: \url{https://github.com/scti1057/qr-code-windshield-cnn}.
Eine kurze “How-to”-Übersicht zum Projektaufbau und zur Ausführung der Skripte befindet sich im Repository
unter \texttt{PROJECT\_DOCUMENTATION}.

Die von uns trainierten Modelle, inkl. Gewichte, Confusion-Matrix und weitere Metriken, sind in einem OneDrive-Ordner verfügbar: \url{https://hskarlsruhede-my.sharepoint.com/:f:/g/personal/glpa1013_h-ka_de/IgAted8wp4JJS7eK5f2-bws9AZJVUITp_f4twW-3-GuC1oM?e=wpzLBD}.
